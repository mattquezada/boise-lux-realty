...
function ContactForm() {
    ...
    async function onSubmit(e) {
        ...
        const payload = {
            ...
            persona: form.elements.namedItem("persona")?.value,
        ...
        try {
            ...
            if (!res.ok || !json?.ok) {
                const msg = json?.error?.message || json?.error || "Lead submission failed (check server logs).";
                throw new Error(msg);
            }
...
_s(ContactForm, "yn90qw6b35hu3F+88UNGFcU2KAg=", false, function() {
    return [
...
//# sourceMappingURL=_c829ae9d._.js.map