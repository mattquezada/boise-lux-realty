        ...
        <div className="container">
          <div className="grid grid-2">
            <div className="card cardPad">
              <h2 className="h2" style={{ fontSize: 30 }}>
                Buyer challenges we solve
              </h2>
              <p className="p">
                Most buyers don’t lose because of price—they lose because their offer isn’t
            ...
            <div className="card cardPad" style={{ background: "var(--fog)" }}>
              ...
              <p className="p">
                We build offers based on reality: comps, seller motivation, inventory trends,
                and terms that reduce friction.
              </p>
